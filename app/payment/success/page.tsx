          ...
          {isLoading ? (
            ...
            >
              <div className="mx-auto mb-6 flex h-12 w-12 items-center justify-center">
                <RiLoader4Line className="text-foreground h-12 w-12 animate-spin" />
              </div>
              <h1 className="text-foreground mb-3 text-2xl font-black">Processing Payment</h1>
              <p className="text-muted-foreground mb-6">
                We&apos;re confirming your payment with our payment provider. This should only take
                a moment...
              </p>
              <div className="bg-muted mx-auto h-1 w-full max-w-xs overflow-hidden rounded-full">
                <motion.div
            ...
            >
              <div className="mx-auto mb-6 flex h-12 w-12 items-center justify-center">
                <div className="border-border bg-muted flex h-12 w-12 items-center justify-center rounded-full border">
                  <RiCheckLine className="text-foreground h-6 w-6" />
                </div>
              </div>

              <h1 className="text-foreground mb-3 text-2xl font-black">Payment Successful</h1>
            ...
            >
              <div className="mx-auto mb-6 flex h-12 w-12 items-center justify-center">
                <div className="border-border bg-muted flex h-12 w-12 items-center justify-center rounded-full border">
                  <span className="text-foreground text-xl font-black">!</span>
                </div>
              </div>

              <h1 className="text-foreground mb-3 text-2xl font-black">Issue Detected</h1>
    ...
    <div className="foundry-page flex min-h-[70vh] items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        <div className="foundry-panel rounded-2xl p-8 text-center">
          ...
          <h1 className="text-foreground mb-3 text-2xl font-black">Loading...</h1>
          <p className="text-muted-foreground mb-6">
