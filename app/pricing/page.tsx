...
export default async function PricingPage() {
  ...
  const faqLd = faqSchema(faqItems.map((item) => ({ question: item.title, answer: item.content })))
  return (
    <div className="foundry-page">
      <JsonLd data={faqLd} />
      <div className="mx-auto max-w-3xl px-4 py-8 md:py-12">
        <div className="scroll-live mb-8 text-center">
          <p className="foundry-kicker mb-3">Launch economics</p>
          <h1 className="font-heading text-foreground mb-3 text-4xl font-black sm:text-5xl">
        ...
        <div className="mx-auto mb-4">
          <div className="foundry-panel grid grid-cols-1 overflow-hidden rounded-2xl md:grid-cols-10">
            {/* Free Launch Option */}
            <div className="flex h-full flex-col p-5 md:col-span-4">
              <div className="flex-grow">
                ...
                <p className="text-muted-foreground mb-3 text-xs">
                  Standard launch with up to {LAUNCH_SETTINGS.MAX_DAYS_AHEAD} days scheduling
                  window.
                </p>
            ...
            <div className="bg-card border-t border-cyan-100/12 p-5 md:col-span-6 md:border-t-0 md:border-l">
