...
// Export other methods without modification. Wrapped (rather than re-exported via
// destructuring) so the handler signatures match Next.js 15's generated route
// validator — Fuma's RouteHandler type uses an optional `comment?` param shape
// that the validator rejects for this optional catch-all route.
