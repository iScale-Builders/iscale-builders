    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-56 overflow-y-auto" align="end" forceMount>
        ...
        <DropdownMenuItem asChild>
          <Link href="/dashboard" prefetch={false} className="flex cursor-pointer items-center">
        ...
        {user.role === "admin" && (
          <DropdownMenuItem asChild>
            <Link href="/admin" prefetch={false} className="flex cursor-pointer items-center">
        ...
        <DropdownMenuItem asChild>
          <Link href="/settings" prefetch={false} className="flex cursor-pointer items-center">
