  ...
  return (
    ...
    >
      <span className="text-muted-foreground relative flex h-4 w-4 items-center justify-center">
        <RiMoonLine className="h-4 w-4 scale-100 rotate-0 transition-all dark:scale-0 dark:-rotate-90" />
        <RiSunLine className="absolute h-4 w-4 scale-0 rotate-90 transition-all dark:scale-100 dark:rotate-0" />
      </span>
