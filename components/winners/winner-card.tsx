...
export function WinnerCard({
  ...
  return (
    <div className="foundry-card overflow-hidden rounded-2xl">
      <div className="p-5">
        <div className="flex items-start gap-4">
          ...
          <div className="min-w-0 flex-1">
            <div className="flex flex-col gap-1">
              <h3 className="text-foreground truncate text-xl font-black">{name}</h3>
              <Badge className="border-border text-foreground border bg-fuchsia-400/10">
                {getRankingText()}
              </Badge>
